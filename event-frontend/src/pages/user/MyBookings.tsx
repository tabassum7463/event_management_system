    ...
    <div className="my-bookings-layout">
      ...
      <main className="my-bookings-main">
        <div className="my-bookings-container">
          ...
          {loading && <p className="center-text">Loading bookings...</p>}
          {!loading && error && <p className="center-text error-text">{error}</p>}
          {!loading && !error && bookings.length === 0 && <p className="center-text">No bookings found.</p>}
            ...
            bookings.map((b) => {
              ...
              return (
                <div key={b.id} className="booking-card">
                  ...
                  <p>
                    <strong>City:</strong> {b.event.city}
                  </p>
                  ...
                  <p>
                    <strong>Tickets:</strong> {b.quantity}
                  </p>
                  <p>
                    <strong>Total Paid:</strong> Rs {b.totalPrice}
                  </p>
