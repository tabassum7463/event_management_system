...
export default function CreateEvent() {
  ...
  const validateForm = (): boolean => {
    ...
    const isAllEmpty =
      ...
      (form.totalSeats === "" || form.totalSeats === 0);
    ...
    if (form.totalSeats === "" || form.totalSeats <= 0) errs.push("Total seats must be greater than 0.");
    ...
    if (form.startTime && form.endTime && form.startTime >= form.endTime) errs.push("Start time must be before end time.");
      ...
      <main className="create-event-main">
        ...
        <form className="create-event-form" onSubmit={handleSubmit}>
          <div className="form-row">
            <input type="text" name="title" placeholder="Event Title" value={form.title} onChange={handleChange} />
          ...
          <div className="form-row">
            <input type="time" name="startTime" placeholder="Start Time" value={form.startTime} onChange={handleChange} />
            <input type="time" name="endTime" placeholder="End Time" value={form.endTime} onChange={handleChange} />
          </div>
